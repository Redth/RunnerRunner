...
HOSTWORKER_PUBLIC_SERVER_URL="${HOSTWORKER_PUBLIC_SERVER_URL:-http://${LINUX_HOST}:${HOSTWORKER_GRPC_PORT}}"
HOSTWORKER_UPDATE_PUBLIC_BASE_URL="${HOSTWORKER_UPDATE_PUBLIC_BASE_URL:-http://${LINUX_HOST}:${SERVER_PORT}}"
